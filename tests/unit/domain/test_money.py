...
def test_money_negation():
    ...
    assert neg.currency == Currency.USD


def test_money_type_error():
    with pytest.raises(TypeError, match="Money amount must be int"):
        Money(10.5, Currency.USD)  # type: ignore
